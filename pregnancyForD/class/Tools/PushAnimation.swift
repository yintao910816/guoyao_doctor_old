...
extension PushAnimation : UIViewControllerAnimatedTransitioning {
    ...
    func puchAnimation(){
        ...
        UIView.animate(withDuration: duration, delay: 0, usingSpringWithDamping: 1, initialSpringVelocity: 0, options: UIView.AnimationOptions.curveLinear, animations: {[unowned self]()in
